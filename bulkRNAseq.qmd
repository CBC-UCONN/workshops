...
This workshop covers the basics of differential expression analysis at the gene level with bulk RNA-seq data, *assuming a reference genome and both structural and functional annotation are available*. This workflow can apply to model organisms, and those with genomic resources already available. 
